...
class RecipeFilter(django_filters.FilterSet):
    ...
    def filter_is_favorited(self, queryset, name, value):
        ...
        # то не применяем этот фильтр активно (или можно отфильтровать те, что НЕ в избранном)
        # Для простоты, если value=True и не аутентифицирован, вернет пустой queryset,
        # т.к. аноним не может иметь избранного.
