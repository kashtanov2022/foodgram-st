...
from .models import (
    Tag, Ingredient, Recipe, AmountIngredient,
...
class RecipeAdmin(admin.ModelAdmin):
    ...
    @admin.display(
        description='В избранном (на странице рецепта)'
    )
...
class AmountIngredientAdmin(admin.ModelAdmin):
    list_display = (
        'id', 'recipe_link', 'ingredient_link', 'amount'
    )
    search_fields = (
...
class FavoriteAdmin(admin.ModelAdmin):
    list_display = (
        'id', 'user_link', 'recipe_link', 'added_at'
    )
    search_fields = (
